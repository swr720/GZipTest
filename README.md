...
расжатия файлов с помощью System.IO.Compression.GzipStream. <br>
...
объем доступной оперативной памяти. <br>
...
частности если проблемы связаны с ограничениями операционной системы. <br>
...
реализация с использованием Thread-ов. <br>
...
в командной строке следующим образом: <br>
